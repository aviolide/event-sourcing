...
process.env.AUTH_SERVICE_URL =
  process.env.AUTH_SERVICE_URL ?? 'http://auth.local:3010';
process.env.WALLET_SERVICE_URL =
  process.env.WALLET_SERVICE_URL ?? 'http://wallet.local:3020';
process.env.PAYMENTS_SERVICE_URL =
  process.env.PAYMENTS_SERVICE_URL ?? 'http://payments.local:3030';
